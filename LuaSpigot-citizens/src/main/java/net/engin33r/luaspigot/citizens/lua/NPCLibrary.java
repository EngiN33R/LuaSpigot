...
public class NPCLibrary extends Library {
    ...
    @LibraryFunctionDefinition(value = "getByUUID")
    ...
    @LibraryFunctionDefinition(value = "withTrait")
    ...
    @LibraryFunctionDefinition(value = "defineTrait")
